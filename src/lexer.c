...
static ds_result lexer_tokenize_symbol(lexer_t *lexer, token_t *token) {
...
static ds_result lexer_tokenize_number(lexer_t *lexer, token_t *token) {
    ds_result result = DS_OK;
    unsigned int position = lexer->pos;
...
static ds_result lexer_tokenize_set(lexer_t *lexer, token_t *token) {
    ds_result result = DS_OK;
    unsigned int position = lexer->pos;
...
static ds_result lexer_tokenize_name(lexer_t *lexer, token_t *token) {
    ds_result result = DS_OK;
    unsigned int position = lexer->pos;
